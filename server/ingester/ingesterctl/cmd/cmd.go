...
func RegisterIngesterCommand(root *cobra.Command) {
	...
	prometheusCmd.AddCommand(debug.ClientRegisterSimple(decoder.CMD_PROMETHEUS_LABEL, debug.CmdHelper{"label [metric|name|value|column|target]", "show prometheus labels"}, nil))
