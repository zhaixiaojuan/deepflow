...
srt                         , 平均 TCP 系统时延       , 微秒 , 统计周期内，所有 TCP 系统时延的平均值，一次时延的计算见文档描述
...
srt_max                     , 最大 TCP 系统时延       , 微秒 , 统计周期内，所有 TCP 系统时延的最大值，一次时延的计算见文档描述 
...
l7_request                  , 应用请求                , 个   , 请求    
l7_response                 , 应用响应                , 个   , 响应    
...
vpc                         , VPC                     ,     , 统计查看的数据中 VPC 的    
subnet                      , 子网                    ,      , 统计查看的数据中子网的    
ip                          , IP 地址                 ,      , 统计查看的数据中 IP 的    
pod_cluster                 , 容器集群                ,      , 统计查看的数据中容器集群的    
pod_node                    , 容器节点                ,      , 统计查看的数据中容器节点的    
pod_ns                      , 命名空间                ,      , 统计查看的数据中命名空间的    
pod_group                   , 工作负载                ,      , 统计查看的数据中工作负载的    
pod                         , POD                     ,      , 统计查看的数据中 POD 的    
host                        , 宿主机                  ,      , 统计查看的数据中宿主机的    
chost                       , 云服务器                ,      , 统计查看的数据中云服务器的    
region                      , 区域                    ,      , 统计查看的数据中区域的    
az                          , 可用区                  ,      , 统计查看的数据中可用区的    
ip_version                  , IP 类型                 ,      , 统计查看的数据中 IP 类型的    
tap_type                    , 采集点                  ,      , 统计查看的数据中采集点的    
vtap_id                     , 采集器                  ,      , 统计查看的数据中采集器的    
protocol                    , 网络协议                ,      , 统计查看的数据中网络协议的    
server_port                 , 服务端口                ,      , 统计查看的数据中服务端的    
row                         , 行数                    , 个   ,  
