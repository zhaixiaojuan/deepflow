...
func Start() {
	...
	err = stats.RegisterCountableWithModulePrefix("controller.", "trisolaris", GetPrometheusLabelIDsCounterSingleton(), stats.OptionStatTags{"grpc_type": "GetPrometheusLabelIDs"})
	if err != nil {
		log.Error(err)
	}
}
