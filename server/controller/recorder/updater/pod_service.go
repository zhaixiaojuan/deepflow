...
type PodService struct {
	UpdaterBase[cloudmodel.PodService, mysql.PodService, *diffbase.PodService, *message.PodServiceAdd, message.PodServiceAdd, *message.PodServiceUpdate, message.PodServiceUpdate, *message.PodServiceFieldsUpdate, message.PodServiceFieldsUpdate, *message.PodServiceDelete, message.PodServiceDelete]
}

func NewPodService(wholeCache *cache.Cache, cloudData []cloudmodel.PodService) *PodService {
	updater := &PodService{
		newUpdaterBase[cloudmodel.PodService, mysql.PodService, *diffbase.PodService, *message.PodServiceAdd, message.PodServiceAdd, *message.PodServiceUpdate, message.PodServiceUpdate, *message.PodServiceFieldsUpdate, message.PodServiceFieldsUpdate, *message.PodServiceDelete, message.PodServiceDelete](
