...
type FloatingIP struct {
	UpdaterBase[cloudmodel.FloatingIP, mysql.FloatingIP, *diffbase.FloatingIP, *message.FloatingIPAdd, message.FloatingIPAdd, *message.FloatingIPUpdate, message.FloatingIPUpdate, *message.FloatingIPFieldsUpdate, message.FloatingIPFieldsUpdate, *message.FloatingIPDelete, message.FloatingIPDelete]
}

func NewFloatingIP(wholeCache *cache.Cache, cloudData []cloudmodel.FloatingIP) *FloatingIP {
	updater := &FloatingIP{
		newUpdaterBase[cloudmodel.FloatingIP, mysql.FloatingIP, *diffbase.FloatingIP, *message.FloatingIPAdd, message.FloatingIPAdd, *message.FloatingIPUpdate, message.FloatingIPUpdate, *message.FloatingIPFieldsUpdate, message.FloatingIPFieldsUpdate, *message.FloatingIPDelete](
