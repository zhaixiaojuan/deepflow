...
type PodReplicaSet struct {
	UpdaterBase[cloudmodel.PodReplicaSet, mysql.PodReplicaSet, *diffbase.PodReplicaSet, *message.PodReplicaSetAdd, message.PodReplicaSetAdd, *message.PodReplicaSetUpdate, message.PodReplicaSetUpdate, *message.PodReplicaSetFieldsUpdate, message.PodReplicaSetFieldsUpdate, *message.PodReplicaSetDelete, message.PodReplicaSetDelete]
}

func NewPodReplicaSet(wholeCache *cache.Cache, cloudData []cloudmodel.PodReplicaSet) *PodReplicaSet {
	updater := &PodReplicaSet{
		newUpdaterBase[cloudmodel.PodReplicaSet, mysql.PodReplicaSet, *diffbase.PodReplicaSet, *message.PodReplicaSetAdd, message.PodReplicaSetAdd, *message.PodReplicaSetUpdate, message.PodReplicaSetUpdate, *message.PodReplicaSetFieldsUpdate, message.PodReplicaSetFieldsUpdate, *message.PodReplicaSetDelete, message.PodReplicaSetDelete](
