...
type VM struct {
	UpdaterBase[cloudmodel.VM, mysql.VM, *diffbase.VM, *message.VMAdd, message.VMAdd, *message.VMUpdate, message.VMUpdate, *message.VMFieldsUpdate, message.VMFieldsUpdate, *message.VMDelete, message.VMDelete]
}

func NewVM(wholeCache *cache.Cache, cloudData []cloudmodel.VM) *VM {
	updater := &VM{
		newUpdaterBase[cloudmodel.VM, mysql.VM, *diffbase.VM, *message.VMAdd, message.VMAdd, *message.VMUpdate, message.VMUpdate, *message.VMFieldsUpdate, message.VMFieldsUpdate, *message.VMDelete, message.VMDelete](
