...
type Process struct {
	UpdaterBase[cloudmodel.Process, mysql.Process, *diffbase.Process, *message.ProcessAdd, message.ProcessAdd, *message.ProcessUpdate, message.ProcessUpdate, *message.ProcessFieldsUpdate, message.ProcessFieldsUpdate, *message.ProcessDelete, message.ProcessDelete]
}

func NewProcess(wholeCache *cache.Cache, cloudData []cloudmodel.Process) *Process {
	updater := &Process{
		newUpdaterBase[cloudmodel.Process, mysql.Process, *diffbase.Process, *message.ProcessAdd, message.ProcessAdd, *message.ProcessUpdate, message.ProcessUpdate, *message.ProcessFieldsUpdate, message.ProcessFieldsUpdate, *message.ProcessDelete, message.ProcessDelete](
