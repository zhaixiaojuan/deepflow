...
type VIP struct {
	UpdaterBase[cloudmodel.VIP, mysql.VIP, *diffbase.VIP, *message.VIPAdd, message.VIPAdd, *message.VIPUpdate, message.VIPUpdate, *message.VIPFieldsUpdate, message.VIPFieldsUpdate, *message.VIPDelete, message.VIPDelete]
}

func NewVIP(wholeCache *cache.Cache, cloudData []cloudmodel.VIP) *VIP {
	updater := &VIP{
		newUpdaterBase[cloudmodel.VIP, mysql.VIP, *diffbase.VIP, *message.VIPAdd, message.VIPAdd, *message.VIPUpdate, message.VIPUpdate, *message.VIPFieldsUpdate, message.VIPFieldsUpdate, *message.VIPDelete, message.VIPDelete](
