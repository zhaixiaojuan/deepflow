...
type AZ struct {
	UpdaterBase[cloudmodel.AZ, mysql.AZ, *diffbase.AZ, *message.AZAdd, message.AZAdd, *message.AZUpdate, message.AZUpdate, *message.AZFieldsUpdate, message.AZFieldsUpdate, *message.AZDelete, message.AZDelete]
}

func NewAZ(wholeCache *cache.Cache, cloudData []cloudmodel.AZ) *AZ {
	updater := &AZ{
		newUpdaterBase[cloudmodel.AZ, mysql.AZ, *diffbase.AZ, *message.AZAdd, message.AZAdd, *message.AZUpdate, message.AZUpdate, *message.AZFieldsUpdate, message.AZFieldsUpdate, *message.AZDelete](
