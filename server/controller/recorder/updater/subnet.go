...
type Subnet struct {
	UpdaterBase[cloudmodel.Subnet, mysql.Subnet, *diffbase.Subnet, *message.SubnetAdd, message.SubnetAdd, *message.SubnetUpdate, message.SubnetUpdate, *message.SubnetFieldsUpdate, message.SubnetFieldsUpdate, *message.SubnetDelete, message.SubnetDelete]
}

func NewSubnet(wholeCache *cache.Cache, cloudData []cloudmodel.Subnet) *Subnet {
	updater := &Subnet{
		newUpdaterBase[cloudmodel.Subnet, mysql.Subnet, *diffbase.Subnet, *message.SubnetAdd, message.SubnetAdd, *message.SubnetUpdate, message.SubnetUpdate, *message.SubnetFieldsUpdate, message.SubnetFieldsUpdate, *message.SubnetDelete, message.SubnetDelete](
