...
type RDSInstance struct {
	UpdaterBase[cloudmodel.RDSInstance, mysql.RDSInstance, *diffbase.RDSInstance, *message.RDSInstanceAdd, message.RDSInstanceAdd, *message.RDSInstanceUpdate, message.RDSInstanceUpdate, *message.RDSInstanceFieldsUpdate, message.RDSInstanceFieldsUpdate, *message.RDSInstanceDelete, message.RDSInstanceDelete]
}

func NewRDSInstance(wholeCache *cache.Cache, cloudData []cloudmodel.RDSInstance) *RDSInstance {
	updater := &RDSInstance{
		newUpdaterBase[cloudmodel.RDSInstance, mysql.RDSInstance, *diffbase.RDSInstance, *message.RDSInstanceAdd, message.RDSInstanceAdd, *message.RDSInstanceUpdate, message.RDSInstanceUpdate, *message.RDSInstanceFieldsUpdate, message.RDSInstanceFieldsUpdate, *message.RDSInstanceDelete, message.RDSInstanceDelete](
