...
type LB struct {
	UpdaterBase[cloudmodel.LB, mysql.LB, *diffbase.LB, *message.LBAdd, message.LBAdd, *message.LBUpdate, message.LBUpdate, *message.LBFieldsUpdate, message.LBFieldsUpdate, *message.LBDelete, message.LBDelete]
}

func NewLB(wholeCache *cache.Cache, cloudData []cloudmodel.LB) *LB {
	updater := &LB{
		newUpdaterBase[cloudmodel.LB, mysql.LB, *diffbase.LB, *message.LBAdd, message.LBAdd, *message.LBUpdate, message.LBUpdate, *message.LBFieldsUpdate, message.LBFieldsUpdate, *message.LBDelete](
