...
type LBVMConnection struct {
	UpdaterBase[cloudmodel.LBVMConnection, mysql.LBVMConnection, *diffbase.LBVMConnection, *message.LBVMConnectionAdd, message.LBVMConnectionAdd, *message.LBVMConnectionUpdate, message.LBVMConnectionUpdate, *message.LBVMConnectionFieldsUpdate, message.LBVMConnectionFieldsUpdate, *message.LBVMConnectionDelete, message.LBVMConnectionDelete]
}

func NewLBVMConnection(wholeCache *cache.Cache, cloudData []cloudmodel.LBVMConnection) *LBVMConnection {
	updater := &LBVMConnection{
		newUpdaterBase[cloudmodel.LBVMConnection, mysql.LBVMConnection, *diffbase.LBVMConnection, *message.LBVMConnectionAdd, message.LBVMConnectionAdd, *message.LBVMConnectionUpdate, message.LBVMConnectionUpdate, *message.LBVMConnectionFieldsUpdate, message.LBVMConnectionFieldsUpdate, *message.LBVMConnectionDelete](
