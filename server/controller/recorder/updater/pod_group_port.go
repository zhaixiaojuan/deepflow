...
type PodGroupPort struct {
	UpdaterBase[cloudmodel.PodGroupPort, mysql.PodGroupPort, *diffbase.PodGroupPort, *message.PodGroupPortAdd, message.PodGroupPortAdd, *message.PodGroupPortUpdate, message.PodGroupPortUpdate, *message.PodGroupPortFieldsUpdate, message.PodGroupPortFieldsUpdate, *message.PodGroupPortDelete, message.PodGroupPortDelete]
}

func NewPodGroupPort(wholeCache *cache.Cache, cloudData []cloudmodel.PodGroupPort) *PodGroupPort {
	updater := &PodGroupPort{
		newUpdaterBase[cloudmodel.PodGroupPort, mysql.PodGroupPort, *diffbase.PodGroupPort, *message.PodGroupPortAdd, message.PodGroupPortAdd, *message.PodGroupPortUpdate, message.PodGroupPortUpdate, *message.PodGroupPortFieldsUpdate, message.PodGroupPortFieldsUpdate, *message.PodGroupPortDelete, message.PodGroupPortDelete](
