...
type SubDomain struct {
	UpdaterBase[cloudmodel.SubDomain, mysql.SubDomain, *diffbase.SubDomain, *message.SubDomainAdd, message.SubDomainAdd, *message.SubDomainUpdate, message.SubDomainUpdate, *message.SubDomainFieldsUpdate, message.SubDomainFieldsUpdate, *message.SubDomainDelete, message.SubDomainDelete]
}

func NewSubDomain(wholeCache *cache.Cache, cloudData []cloudmodel.SubDomain) *SubDomain {
	updater := &SubDomain{
		newUpdaterBase[cloudmodel.SubDomain, mysql.SubDomain, *diffbase.SubDomain, *message.SubDomainAdd, message.SubDomainAdd, *message.SubDomainUpdate, message.SubDomainUpdate, *message.SubDomainFieldsUpdate, message.SubDomainFieldsUpdate, *message.SubDomainDelete, message.SubDomainDelete](
