...
type WANIP struct {
	UpdaterBase[cloudmodel.IP, mysql.WANIP, *diffbase.WANIP, *message.WANIPAdd, message.WANIPAdd, *message.WANIPUpdate, message.WANIPUpdate, *message.WANIPFieldsUpdate, message.WANIPFieldsUpdate, *message.WANIPDelete, message.WANIPDelete]
}

func NewWANIP(wholeCache *cache.Cache, domainToolDataSet *tool.DataSet) *WANIP {
	updater := &WANIP{
		newUpdaterBase[cloudmodel.IP, mysql.WANIP, *diffbase.WANIP, *message.WANIPAdd, message.WANIPAdd, *message.WANIPUpdate, message.WANIPUpdate, *message.WANIPFieldsUpdate, message.WANIPFieldsUpdate, *message.WANIPDelete](
