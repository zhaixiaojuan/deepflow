...
type LBListener struct {
	UpdaterBase[cloudmodel.LBListener, mysql.LBListener, *diffbase.LBListener, *message.LBListenerAdd, message.LBListenerAdd, *message.LBListenerUpdate, message.LBListenerUpdate, *message.LBListenerFieldsUpdate, message.LBListenerFieldsUpdate, *message.LBListenerDelete, message.LBListenerDelete]
}

func NewLBListener(wholeCache *cache.Cache, cloudData []cloudmodel.LBListener) *LBListener {
	updater := &LBListener{
		newUpdaterBase[cloudmodel.LBListener, mysql.LBListener, *diffbase.LBListener, *message.LBListenerAdd, message.LBListenerAdd, *message.LBListenerUpdate, message.LBListenerUpdate, *message.LBListenerFieldsUpdate, message.LBListenerFieldsUpdate, *message.LBListenerDelete](
