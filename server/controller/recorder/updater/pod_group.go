...
type PodGroup struct {
	UpdaterBase[cloudmodel.PodGroup, mysql.PodGroup, *diffbase.PodGroup, *message.PodGroupAdd, message.PodGroupAdd, *message.PodGroupUpdate, message.PodGroupUpdate, *message.PodGroupFieldsUpdate, message.PodGroupFieldsUpdate, *message.PodGroupDelete, message.PodGroupDelete]
}

func NewPodGroup(wholeCache *cache.Cache, cloudData []cloudmodel.PodGroup) *PodGroup {
	updater := &PodGroup{
		newUpdaterBase[cloudmodel.PodGroup, mysql.PodGroup, *diffbase.PodGroup, *message.PodGroupAdd, message.PodGroupAdd, *message.PodGroupUpdate, message.PodGroupUpdate, *message.PodGroupFieldsUpdate, message.PodGroupFieldsUpdate, *message.PodGroupDelete, message.PodGroupDelete](
