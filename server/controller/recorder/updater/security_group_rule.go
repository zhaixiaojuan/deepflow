...
type SecurityGroupRule struct {
	UpdaterBase[cloudmodel.SecurityGroupRule, mysql.SecurityGroupRule, *diffbase.SecurityGroupRule, *message.SecurityGroupRuleAdd, message.SecurityGroupRuleAdd, *message.SecurityGroupRuleUpdate, message.SecurityGroupRuleUpdate, *message.SecurityGroupRuleFieldsUpdate, message.SecurityGroupRuleFieldsUpdate, *message.SecurityGroupRuleDelete, message.SecurityGroupRuleDelete]
}
...
func NewSecurityGroupRule(wholeCache *cache.Cache, cloudData []cloudmodel.SecurityGroupRule) *SecurityGroupRule {
	updater := &SecurityGroupRule{
		newUpdaterBase[cloudmodel.SecurityGroupRule, mysql.SecurityGroupRule, *diffbase.SecurityGroupRule, *message.SecurityGroupRuleAdd, message.SecurityGroupRuleAdd, *message.SecurityGroupRuleUpdate, message.SecurityGroupRuleUpdate, *message.SecurityGroupRuleFieldsUpdate, message.SecurityGroupRuleFieldsUpdate, *message.SecurityGroupRuleDelete, message.SecurityGroupRuleDelete](
