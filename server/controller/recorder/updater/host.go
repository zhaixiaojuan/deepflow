...
type Host struct {
	UpdaterBase[cloudmodel.Host, mysql.Host, *diffbase.Host, *message.HostAdd, message.HostAdd, *message.HostUpdate, message.HostUpdate, *message.HostFieldsUpdate, message.HostFieldsUpdate, *message.HostDelete, message.HostDelete]
}

func NewHost(wholeCache *cache.Cache, cloudData []cloudmodel.Host) *Host {
	updater := &Host{
		newUpdaterBase[cloudmodel.Host, mysql.Host, *diffbase.Host, *message.HostAdd, message.HostAdd, *message.HostUpdate, message.HostUpdate, *message.HostFieldsUpdate, message.HostFieldsUpdate, *message.HostDelete](
