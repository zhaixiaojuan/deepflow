...
type PodIngress struct {
	UpdaterBase[cloudmodel.PodIngress, mysql.PodIngress, *diffbase.PodIngress, *message.PodIngressAdd, message.PodIngressAdd, *message.PodIngressUpdate, message.PodIngressUpdate, *message.PodIngressFieldsUpdate, message.PodIngressFieldsUpdate, *message.PodIngressDelete, message.PodIngressDelete]
}

func NewPodIngress(wholeCache *cache.Cache, cloudData []cloudmodel.PodIngress) *PodIngress {
	updater := &PodIngress{
		newUpdaterBase[cloudmodel.PodIngress, mysql.PodIngress, *diffbase.PodIngress, *message.PodIngressAdd, message.PodIngressAdd, *message.PodIngressUpdate, message.PodIngressUpdate, *message.PodIngressFieldsUpdate, message.PodIngressFieldsUpdate, *message.PodIngressDelete, message.PodIngressDelete](
