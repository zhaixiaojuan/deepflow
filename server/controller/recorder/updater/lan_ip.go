...
type LANIP struct {
	UpdaterBase[cloudmodel.IP, mysql.LANIP, *diffbase.LANIP, *message.LANIPAdd, message.LANIPAdd, *message.LANIPUpdate, message.LANIPUpdate, *message.LANIPFieldsUpdate, message.LANIPFieldsUpdate, *message.LANIPDelete, message.LANIPDelete]
}

func NewLANIP(wholeCache *cache.Cache, domainToolDataSet *tool.DataSet) *LANIP {
	updater := &LANIP{
		newUpdaterBase[cloudmodel.IP, mysql.LANIP, *diffbase.LANIP, *message.LANIPAdd, message.LANIPAdd, *message.LANIPUpdate, message.LANIPUpdate, *message.LANIPFieldsUpdate, message.LANIPFieldsUpdate, *message.LANIPDelete](
