...
type CEN struct {
	UpdaterBase[cloudmodel.CEN, mysql.CEN, *diffbase.CEN, *message.CENAdd, message.CENAdd, *message.CENUpdate, message.CENUpdate, *message.CENFieldsUpdate, message.CENFieldsUpdate, *message.CENDelete, message.CENDelete]
}

func NewCEN(wholeCache *cache.Cache, cloudData []cloudmodel.CEN) *CEN {
	updater := &CEN{
		newUpdaterBase[cloudmodel.CEN, mysql.CEN, *diffbase.CEN, *message.CENAdd, message.CENAdd, *message.CENUpdate, message.CENUpdate, *message.CENFieldsUpdate, message.CENFieldsUpdate, *message.CENDelete](
