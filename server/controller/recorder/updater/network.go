...
type Network struct {
	UpdaterBase[cloudmodel.Network, mysql.Network, *diffbase.Network, *message.NetworkAdd, message.NetworkAdd, *message.NetworkUpdate, message.NetworkUpdate, *message.NetworkFieldsUpdate, message.NetworkFieldsUpdate, *message.NetworkDelete, message.NetworkDelete]
}

func NewNetwork(wholeCache *cache.Cache, cloudData []cloudmodel.Network) *Network {
	updater := &Network{
		newUpdaterBase[cloudmodel.Network, mysql.Network, *diffbase.Network, *message.NetworkAdd, message.NetworkAdd, *message.NetworkUpdate, message.NetworkUpdate, *message.NetworkFieldsUpdate, message.NetworkFieldsUpdate, *message.NetworkDelete, message.NetworkDelete](
