...
type VPC struct {
	UpdaterBase[cloudmodel.VPC, mysql.VPC, *diffbase.VPC, *message.VPCAdd, message.VPCAdd, *message.VPCUpdate, message.VPCUpdate, *message.VPCFieldsUpdate, message.VPCFieldsUpdate, *message.VPCDelete, message.VPCDelete]
}

func NewVPC(wholeCache *cache.Cache, cloudData []cloudmodel.VPC) *VPC {
	updater := &VPC{
		newUpdaterBase[cloudmodel.VPC, mysql.VPC, *diffbase.VPC, *message.VPCAdd, message.VPCAdd, *message.VPCUpdate, message.VPCUpdate, *message.VPCFieldsUpdate, message.VPCFieldsUpdate, *message.VPCDelete](
