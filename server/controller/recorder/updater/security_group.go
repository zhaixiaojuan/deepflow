...
type SecurityGroup struct {
	UpdaterBase[cloudmodel.SecurityGroup, mysql.SecurityGroup, *diffbase.SecurityGroup, *message.SecurityGroupAdd, message.SecurityGroupAdd, *message.SecurityGroupUpdate, message.SecurityGroupUpdate, *message.SecurityGroupFieldsUpdate, message.SecurityGroupFieldsUpdate, *message.SecurityGroupDelete, message.SecurityGroupDelete]
}

func NewSecurityGroup(wholeCache *cache.Cache, cloudData []cloudmodel.SecurityGroup) *SecurityGroup {
	updater := &SecurityGroup{
		newUpdaterBase[cloudmodel.SecurityGroup, mysql.SecurityGroup, *diffbase.SecurityGroup, *message.SecurityGroupAdd, message.SecurityGroupAdd, *message.SecurityGroupUpdate, message.SecurityGroupUpdate, *message.SecurityGroupFieldsUpdate, message.SecurityGroupFieldsUpdate, *message.SecurityGroupDelete, message.SecurityGroupDelete](
