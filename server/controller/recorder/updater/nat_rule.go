...
type NATRule struct {
	UpdaterBase[cloudmodel.NATRule, mysql.NATRule, *diffbase.NATRule, *message.NATRuleAdd, message.NATRuleAdd, *message.NATRuleUpdate, message.NATRuleUpdate, *message.NATRuleFieldsUpdate, message.NATRuleFieldsUpdate, *message.NATRuleDelete, message.NATRuleDelete]
}

func NewNATRule(wholeCache *cache.Cache, cloudData []cloudmodel.NATRule) *NATRule {
	updater := &NATRule{
		newUpdaterBase[cloudmodel.NATRule, mysql.NATRule, *diffbase.NATRule, *message.NATRuleAdd, message.NATRuleAdd, *message.NATRuleUpdate, message.NATRuleUpdate, *message.NATRuleFieldsUpdate, message.NATRuleFieldsUpdate, *message.NATRuleDelete, message.NATRuleDelete](
