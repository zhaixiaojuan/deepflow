...
type VRouter struct {
	UpdaterBase[cloudmodel.VRouter, mysql.VRouter, *diffbase.VRouter, *message.VRouterAdd, message.VRouterAdd, *message.VRouterUpdate, message.VRouterUpdate, *message.VRouterFieldsUpdate, message.VRouterFieldsUpdate, *message.VRouterDelete, message.VRouterDelete]
}

func NewVRouter(wholeCache *cache.Cache, cloudData []cloudmodel.VRouter) *VRouter {
	updater := &VRouter{
		newUpdaterBase[cloudmodel.VRouter, mysql.VRouter, *diffbase.VRouter, *message.VRouterAdd, message.VRouterAdd, *message.VRouterUpdate, message.VRouterUpdate, *message.VRouterFieldsUpdate, message.VRouterFieldsUpdate, *message.VRouterDelete](
