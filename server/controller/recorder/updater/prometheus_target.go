...
type PrometheusTarget struct {
	UpdaterBase[cloudmodel.PrometheusTarget, mysql.PrometheusTarget, *diffbase.PrometheusTarget, *message.PrometheusTargetAdd, message.PrometheusTargetAdd, *message.PrometheusTargetUpdate, message.PrometheusTargetUpdate, *message.PrometheusTargetFieldsUpdate, message.PrometheusTargetFieldsUpdate, *message.PrometheusTargetDelete, message.PrometheusTargetDelete]
}
...
func NewPrometheusTarget(wholeCache *cache.Cache, cloudData []cloudmodel.PrometheusTarget) *PrometheusTarget {
	updater := &PrometheusTarget{
		newUpdaterBase[cloudmodel.PrometheusTarget, mysql.PrometheusTarget, *diffbase.PrometheusTarget, *message.PrometheusTargetAdd, message.PrometheusTargetAdd, *message.PrometheusTargetUpdate, message.PrometheusTargetUpdate, *message.PrometheusTargetFieldsUpdate, message.PrometheusTargetFieldsUpdate, *message.PrometheusTargetDelete](
