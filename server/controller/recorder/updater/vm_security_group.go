...
type VMSecurityGroup struct {
	UpdaterBase[cloudmodel.VMSecurityGroup, mysql.VMSecurityGroup, *diffbase.VMSecurityGroup, *message.VMSecurityGroupAdd, message.VMSecurityGroupAdd, *message.VMSecurityGroupUpdate, message.VMSecurityGroupUpdate, *message.VMSecurityGroupFieldsUpdate, message.VMSecurityGroupFieldsUpdate, *message.VMSecurityGroupDelete, message.VMSecurityGroupDelete]
}
...
func NewVMSecurityGroup(wholeCache *cache.Cache, cloudData []cloudmodel.VMSecurityGroup) *VMSecurityGroup {
	updater := &VMSecurityGroup{
		newUpdaterBase[cloudmodel.VMSecurityGroup, mysql.VMSecurityGroup, *diffbase.VMSecurityGroup, *message.VMSecurityGroupAdd, message.VMSecurityGroupAdd, *message.VMSecurityGroupUpdate, message.VMSecurityGroupUpdate, *message.VMSecurityGroupFieldsUpdate, message.VMSecurityGroupFieldsUpdate, *message.VMSecurityGroupDelete, message.VMSecurityGroupDelete](
