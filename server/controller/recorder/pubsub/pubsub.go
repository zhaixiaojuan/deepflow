...
type SingleResourcePubSub[MAPT constraint.AddPtr[MAT], MAT constraint.Add, MUPT constraint.UpdatePtr[MUT], MUT constraint.Update, MFUPT constraint.FieldsUpdatePtr[MFUT], MFUT constraint.FieldsUpdate, MDPT constraint.DeletePtr[MDT], MDT constraint.Delete] interface {
	PubSub
	PublishChange()
	PublishAdd(MAPT)
	PublishUpdate(MUPT)
...
type SingleResourcePubSubComponent[MAPT constraint.AddPtr[MAT], MAT constraint.Add, MUPT constraint.UpdatePtr[MUT], MUT constraint.Update, MFUPT constraint.FieldsUpdatePtr[MFUT], MFUT constraint.FieldsUpdate, MDPT constraint.DeletePtr[MDT], MDT constraint.Delete] struct {
	resourceType string
	PubSubComponent
}

func (p *SingleResourcePubSubComponent[MAPT, MAT, MUPT, MUT, MFUPT, MFUT, MDPT, MDT]) PublishChange() {
...
func (p *SingleResourcePubSubComponent[MAPT, MAT, MUPT, MUT, MFUPT, MFUT, MDPT, MDT]) PublishAdd(msg MAPT) {
...
func (p *SingleResourcePubSubComponent[MAPT, MAT, MUPT, MUT, MFUPT, MFUT, MDPT, MDT]) PublishUpdate(msg MUPT) {
...
func (p *SingleResourcePubSubComponent[MAPT, MAT, MUPT, MUT, MFUPT, MFUT, MDPT, MDT]) PublishDelete(msg MDPT) {
